	...
	// },
	{
		...
		children: [
			...
			},
			{
				path: '/musicLib',
				name: 'musicLib',
				component: () => import('/@/views/online/musicLib.vue'),
				meta: {
					title: '音乐馆',
					isLink: '',
					isHide: false,
			...
			{
				path: '/transmitterReceiver',
				name: 'transmitterReceiver',
				component: () => import('/@/views/online/transmitterReceiver.vue'),
				meta: {
					title: '电台',
					isLink: '',
					isHide: false,
			...
			},
			{
				path: '/favorite',
				name: 'favorite',
				component: () => import('/@/views/mine/favorite.vue'),
				meta: {
					title: '我喜欢',
					isLink: '',
					isHide: false,
			...
			},
			{
				path: '/local',
				name: 'local',
				component: () => import('/@/views/mine/local.vue'),
				meta: {
					title: '本地歌曲',
					isLink: '',
					isHide: false,
